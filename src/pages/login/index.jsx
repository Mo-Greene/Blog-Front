...
const Login = () => {
  ...
  const handleLogin = () => {
    ...
    const redirectUri = "https://mo-greene.pro/v1/login/oauth2/code/github";
    const scope = "user";
